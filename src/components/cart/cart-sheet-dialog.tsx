...
export function CartSheet({ children, showLabel = false }: CartSheetProps) {
  ...
  // Use ref to prevent unwanted state changes during mutations
  const isUpdatingRef = useRef(false);

  // Enhanced state setter that respects mutation state
  const handleOpenChange = (newOpen: boolean) => {
    // Don't close if we're in the middle of a cart update
