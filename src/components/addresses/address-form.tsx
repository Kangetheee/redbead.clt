...
interface AddressFormProps {
  ...
  autoFocus?: boolean;
  onSubmitStart?: () => void;
  defaultValues?: Partial<CreateAddressDto>;
}
...
export function AddressForm({
  ...
  const getDefaultValues = (): CreateAddressDto | UpdateAddressDto => {
    if (address) {
      ...
      // Creating new address - merge provided defaults with base defaults
      return {
        name: "",
        recipientName: "",
        companyName: "",
        ...
        addressType: "BOTH",
        isDefault: false,
        ...defaultValues, // Override with provided defaults
      };
    }
  };
  ...
  const onSubmit = async (values: CreateAddressDto | UpdateAddressDto) => {
    try {
      ...
      if (isEditing && address) {
        // For updates, we need to pass addressId and values separately
        result = await updateMutation.mutateAsync({
          addressId: address.id,
          values: values as UpdateAddressDto,
        });
      } else {
        // For creates, we pass the values directly
